      ...
      <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-sans font-bold text-green-700 dark:text-white">
              Our Team
            </h2>
            <p class="font-normal  font-sans text-gray-700 sm:text-xl dark:text-gray-400">
              Meet The Team Of Experts Making This Happen
            </p>
          </div>
          <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                class="mx-auto mb-4 w-36 h-36 rounded-full"
                src="https://media-exp1.licdn.com/dms/image/C4D03AQHyrazuDi5xtg/profile-displayphoto-shrink_800_800/0/1642462347086?e=1672876800&v=beta&t=YlUH_0c-z5L68B-m0H0Plr4Rv5DdtvaIoXCdBAe4wUE"
                alt="Helene Avatar"
              />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Akweley Abena Okai</a>
              </h3>
              <p>UI/UX Designer</p>
              <ul class="flex justify-center mt-4 space-x-4">
                {/* <li>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                class="mx-auto mb-4 w-36 h-36 rounded-full"
                src="https://pbs.twimg.com/profile_images/1482750480501587968/gaqaQQs6_400x400.jpg"
                alt="Jese Avatar"
              />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Samuel Kwame Sampong</a>
              </h3>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <img
                class="mx-auto mb-4 w-36 h-36 rounded-full"
                src="https://pbs.twimg.com/profile_images/1587420160360648704/kL9-B-08_400x400.jpg"
                alt="Joseph Avatar"
              />
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">ALbert Nutifafa Dovlo</a>
              </h3>
              <p>Frontend Developer</p>
              <p>FInance</p>
              <ul class="flex justify-center mt-4 space-x-4">
